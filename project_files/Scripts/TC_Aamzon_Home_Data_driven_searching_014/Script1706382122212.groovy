...
WebUI.setText(findTestObject('Object Repository/Search/Page_Amazon Sign In/input_Email or mobile phone number_email'), username)

WebUI.click(findTestObject('Object Repository/Search/Page_Amazon Sign In/span_Continue'))

WebUI.setText(findTestObject('Object Repository/Search/Page_Amazon Sign In/input_Forgot Password_password'), password)
