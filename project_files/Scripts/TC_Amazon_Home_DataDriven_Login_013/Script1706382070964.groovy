...
WebUI.setText(findTestObject('Object Repository/Login_Test/Page_Amazon Sign In/input_email'), Username)

WebUI.click(findTestObject('Object Repository/Login_Test/Page_Amazon Sign In/inputcontinue'))

WebUI.setEncryptedText(findTestObject('Object Repository/Login_Test/Page_Amazon Sign In/input_password'), password)
